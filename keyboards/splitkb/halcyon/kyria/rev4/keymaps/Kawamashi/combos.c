...
const uint16_t PROGMEM del_combo_d[] = {HRM_T, HRM_S, COMBO_END};
const uint16_t PROGMEM bkspc_combo_d[] = {HRM_S, HRM_R, COMBO_END};
...
const uint16_t PROGMEM tab_combo[] = {HRM_N, HRM_I, COMBO_END};
const uint16_t PROGMEM esc_combo[] = {HRM_N, HRM_A, COMBO_END};
const uint16_t PROGMEM bkspc_combo_g[] = {HRM_A, HRM_I, COMBO_END};
...
const uint16_t PROGMEM alttab_combo[] = {HRM_H, PG_Y, COMBO_END};
const uint16_t PROGMEM altesc_combo[] = {HRM_A, HRM_I, HRM_N, COMBO_END};
