...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      MOD_STB,    PG_Q, PG_EGRV,    PG_Y,    PG_H, PG_TIRE,                         PG_K,    PG_D,    PG_F,    PG_W,  OS_1DK, MOD_ENT,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+----------|                    |---------+--------+-----------+---------+---------+--------|
      _______, HRM_ALL,  HRM_LA,  HRM_DA,  HRM_RA,   KC_PGDN,                      CAPSWORD, HRM_BKS,    HRM_BKW,  HRM_ENT,  HRM_ESC, _______,
  //|--------+--------+--------+--------+--------+----------|                    |---------+--------+-----------+---------+---------+--------|
  ...
  //|--------+--------+--------+--------+--------+----------|                    |--------+--------+--------+--------+--------+--------|
      _______,    KC_8,    KC_7,   HRM_6,   HRM_5,   PG_2PTS,                       PG_IND,   HRM_1,   HRM_2,    KC_3,    KC_4, _______,
  //|--------+--------+--------+--------+--------+----------|                    |--------+--------+--------+--------+--------+--------|
  ...
  //,--------------------------------------------------------.                    ,-----------------------------------------------------.
      _______, XXXXXXX,  KC_SLEP,  KC_BRID,  KC_BRIU, QK_BOOT,                      XXXXXXX,   KC_F1,   KC_F2,   KC_F3,   KC_F4, _______,
  //|--------+--------+---------+---------+---------+--------|                    |--------+--------+--------+--------+--------+--------|
      _______, KC_LGUI, HRM_MUTE, HRM_VOLD, HRM_VOLU,  KC_NUM,                      XXXXXXX,  HRM_F5,  HRM_F6,  HRM_F7,  HRM_F8, _______,
  //|--------+--------+---------+---------+---------+--------|                    |--------+--------+--------+--------+--------+--------|
      _______, XXXXXXX,  KC_MPLY,  KC_MPRV,  KC_MNXT, KC_SCRL,                      XXXXXXX,   KC_F9,  KC_F10,  KC_F11,  KC_F12, _______,
  //|--------+--------+---------+---------+---------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
  ...
  //|--------+-----------+--------+--------+--------+--------|                    |--------+---------+--------+-----------+--------+--------|
      _______, ALGR(PG_O), PG_LPRN, PG_RPRN, PG_PVIR, PG_2PTS,                      PG_BSLS, HRM_SLSH, PG_MOIN,    PG_PLUS, PG_ASTX, _______,
  //|--------+-----------+--------+--------+--------+--------|                    |--------+---------+--------+-----------+--------+--------|
